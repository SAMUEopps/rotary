...
import 'package:rotary/club_page6.dart';
import 'club_page.dart';
import 'club_page1.dart';
import 'club_page4.dart';
import 'club_page3.dart';
import 'club_page7.dart';

void main() => runApp(const ClubPageFive());
...
Widget build(BuildContext context) {
  return MaterialApp(
    ...
    home: const ClubPageFive(),
  );
}

class ClubPageFive extends StatelessWidget {
  const ClubPageFive({super.key});
