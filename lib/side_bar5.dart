...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          const SideBarFivePage(), // Replace with the home screen widget you want to show initially
    );
  }
}

class SideBarFivePage extends StatelessWidget {
  const SideBarFivePage({Key? key}) : super(key: key);
