...
class SideBarSOne extends StatelessWidget {
            ...
            GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const SideBarSTwo()), // Replace EventPage with the actual class name for the event page
                );
              },
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  color: Colors.white, // Rectangular box color
