...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          const SideBarSEight(), // Replace with the home screen widget you want to show initially
    );
  }
}

class SideBarSEight extends StatelessWidget {
  const SideBarSEight({Key? key}) : super(key: key);
